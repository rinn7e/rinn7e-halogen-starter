...
(function($PS) {
  ...
  var component = (function () {
      var render = function (v) {
          return Halogen_HTML_Elements.div([ Shared_Helper.cl("bg-purple-light min-h-screen p-4") ])([ Halogen_HTML_Core.text("This is hero List View") ]);
      };
      var $$eval = function (query) {
          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(query.value0);
      };
...
(function($PS) {
  ...
  var routeSignal = function (driver) {
      return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(function __do() {
          var v = Routing_PushState.makeInterface();
          return Routing_PushState.matches(routing)(function (v1) {
              return function (newRoute) {
                  return function __do() {
                      Effect_Class.liftEffect(Effect_Class.monadEffectEffect)(Effect_Class_Console.log(Effect_Class.monadEffectEffect)("Parsing Route: " + Data_Show.show(Data_Page.showPage)(newRoute)))();
                      var v2 = Effect_Aff.launchAff(driver.query(Halogen_Query.action(Goto.create(newRoute))))();
                      return Data_Unit.unit;
                  };
              };
          })(v)();
  ...
  var handleUrl = function (dictBind) {
      return function (dictMonadEffect) {
          return function (dictMonadState) {
              return function (page) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(dictBind)(Effect_Class.liftEffect(dictMonadEffect)(function __do() {
                      var v = Routing_PushState.makeInterface();
                      ...
                      throw new Error("Failed pattern match at Router (line 113, column 5 - line 117, column 94): " + [ page.constructor.name ]);
                  }))(function () {
  ...
  var handlePage = function (dictBind) {
      return function (dictMonadState) {
          return function (dictMonadEffect) {
              return function (page) {
                  return Control_Bind.bind(dictBind)(Control_Monad_State_Class.gets(dictMonadState)(function (s) {
                      ...
                      if (!v1) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(dictBind)(handleUrl(dictBind)(dictMonadEffect)(dictMonadState)(page))(function () {
                              return Control_Applicative.pure((dictMonadEffect.Monad0()).Applicative0())(Data_Unit.unit);
                          });
                      };
                      throw new Error("Failed pattern match at Router (line 138, column 3 - line 143, column 16): " + [ v1.constructor.name ]);
                  });
              };
          };
      };
  ...
  var view = function (state) {
      if (state.currentPage instanceof Data_Page.HeroListPage) {
          return Shared_Layout.view({
              viewList: [ Halogen_HTML["slot'"](cpHeroList)(Page_HeroList.Slot.value)(Page_HeroList.component)(Data_Unit.unit)(Halogen_HTML_Events.input(HandleHeroListPage.create)) ],
      ...
      throw new Error("Failed pattern match at Router (line 158, column 3 - line 169, column 9): " + [ state.currentPage.constructor.name ]);
  };
  var component = (function () {
      ...
      var $$eval = function (query) {
          if (query instanceof Init) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Shared_Helper.log(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))("Router Initialized"))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(query.value0);
              });
          };
          if (query instanceof Goto) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Shared_Helper.log(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Data_Show.show(Data_Page.showPage)(query.value0)))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handlePage(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.monadStateHalogenM)(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(query.value0))(function () {
          ...
          if (query instanceof HandleHeroListPage) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handlePage(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.monadStateHalogenM)(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(query.value0.value0))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(query.value1);
              });
          };
          ...
          throw new Error("Failed pattern match at Router (line 74, column 7 - line 95, column 21): " + [ query.constructor.name ]);
      };
  ...
  var main = function __do() {
      ...
      return Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(Router.component)(Data_Unit.unit)(v))(function (v1) {
              return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff.forkAff(Router.routeSignal(v1)))(function (v2) {
